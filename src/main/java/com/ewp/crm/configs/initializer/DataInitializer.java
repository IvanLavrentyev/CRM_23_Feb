...
public class DataInitializer {
    ...
    private void init() {
        ...
        Client client1 = new Client("Иван", "Лаврентьев", "79999992288", "ivan.lavrentyev@list.ru", (byte) 21, Client.Sex.MALE, "Тула", "Россия", Client.State.FINISHED, ZonedDateTime.now());
